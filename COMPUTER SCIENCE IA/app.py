...
def dashboard():
    ...
    if start_date and end_date:
        ...
        user_cars = [car for car in user_cars if start_date <= datetime.strptime(car.date, '%Y-%m-%d').date() <= end_date] # Converts string car.date into a datetime object
...
def delete_car(car_id):
    ...
    if car:
        ...
        db.session.commit()
        flash('Date deleted successfully.')
    else:
